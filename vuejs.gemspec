...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Unofficial Vue.js 1.0.20 integration with Asset Pipeline with latest router + resource.}
  spec.description   = %q{Unofficial Vue.js 1.0.20 integration with Asset Pipeline with latest router + resource.}
